Shader "HDRP/CustomTerrainLit"
{
    Properties
    {
        _Layer1_Height_Gradient_Width("Layer1_Height_Gradient_Width", Range(0, 1000)) = 10
        _Layer1_Height_Base_Origin("Layer1_Height_Base_Origin", Float) = 0
        _Layer1_Height_Gradient_Color_Top("Layer1_Height_Gradient_Color_Top", Color) = (1, 0, 0, 0)
        _Layer1_Height_Gradient_Color_Base("Layer1_Height_Gradient_Color_Base", Color) = (0, 0.3510089, 1, 0)
        _Layer1_Height_Gradient_Color_Opacity_Top("Layer1_Height_Gradient_Color_Opacity_Top", Range(0, 1)) = 1
        _Layer1_Height_Gradient_Color_Opacity_Base("Layer1_Height_Gradient_Color_Opacity_Base", Range(0, 1)) = 1
        _Snow_Color_Top("Snow_Color_Top", Color) = (1, 0, 0, 0)
        _Snow_Height_Base_Origin("Snow_Height_Base_Origin", Float) = 0
        _Snow_Height_Gradient_Width("Snow_Height_Gradient_Width", Range(0, 1000)) = 10
        
        //
        // Everything above here comes from Janus' shader graph
        //
...
float _Layer1_Height_Gradient_Width;
float _Layer1_Height_Base_Origin;
float3 _Layer1_Height_Gradient_Color_Top;
float3 _Layer1_Height_Gradient_Color_Base;
float _Layer1_Height_Gradient_Color_Opacity_Top;
float _Layer1_Height_Gradient_Color_Opacity_Base;
float3 _Snow_Color_Top;
float _Snow_Height_Base_Origin;
float _Snow_Height_Gradient_Width;
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex Vert
            #pragma fragment Frag //FragGBuffer
